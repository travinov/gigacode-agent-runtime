...
RELEASE_TAG=${GIGACODE_AGENT_RUNTIME_RELEASE_TAG:-v1.0.0-rc.2}
RELEASE_VERSION=${GIGACODE_AGENT_RUNTIME_RELEASE_VERSION:-1.0.0}
EXPECTED_SHA256=${GIGACODE_AGENT_RUNTIME_EXPECTED_SHA256:-9e42382a343310ec0413927570611f9539ecf4353bfe89fceff39d3535201f78}
